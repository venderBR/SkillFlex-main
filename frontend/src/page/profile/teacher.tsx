...
import { GetTeacherById,GetApprovedCoursesByID } from "../../services/https/index";
...
const { Meta } = Card;
export const TeacherE = (): JSX.Element => {
    ...
    return (
        <div className="element2">
            ...
            <div className="overlap">
                ...
                <Link to="/upload_course" className="text1">+ ADD MYCOURSE</Link>
                </div>
                <Divider className="courselist" orientation="left" >Approves Course</Divider>
                    
                    <div className="block" id="home1" >
                        <Link to="/profileT/edit" className="text" id="edit" >EDIT PROFILE</Link>
                    </div>
                    <div className="block" id="home2" >
                        <Link to="/profileT/DiscCourse" className="text" id="edit2" >DISAPPROVE COURSE</Link>
                    </div>
                    {/* <div className="block" id="home3" >
                        <Link to="/profileT/DiscCourse" className="text" id="edit3" >All COURSE</Link>
                    </div> */}

...
import { CreateStudent } from "../../services/https/indexStudent"

const RegisterStudent: React.FC = () => {
    const [form] = Form.useForm(); // ต้องเพิ่มบรรทัดนี้เพื่อกำหนด form ให้ถูกต้อง
    ...
    return (
        <div className="reg1">
            <Form
                ...
                autoComplete="off"
            >
                <header id="header1" className="card">
